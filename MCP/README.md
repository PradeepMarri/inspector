# @Modelcontextprotocol/Inspector API MCP Server

This MCP (Model Content Protocol) server provides access to @Modelcontextprotocol/Inspector API API functionality through HTTP, HTTPS, and STDIO transport modes.
